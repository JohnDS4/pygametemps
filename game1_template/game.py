...
def normalise_input(user_input):
    ...
    normaltxt = remove_spaces(remove_punct(user_input))
    return normaltxt.lower()
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        user_destination = normalise_input(user_destination)
        
        # Check if the input makes sense (is valid exit)
        if is_valid_exit(exits, user_destination) :
